...
void SEASON3B::CNewUIOptionWindow::InitFontSizeCombo()
{
    m_FontSizeCombo.Setup(
        m_Pos.x + FONTSIZE_COMBO_X_LOCAL,
        m_Pos.y + FONTSIZE_COMBO_Y_LOCAL,
        FONTSIZE_COMBO_WIDTH,
        FONTSIZE_COMBO_HEIGHT,
        GetFontSizeLabels(),
        s_NumFontSizes,
        m_iFontSizeIndex,
        FONTSIZE_COMBO_MAX_VISIBLE);
}
...
void SEASON3B::CNewUIOptionWindow::SetPos(int x, int y)
{
    ...
    m_FontSizeCombo.SetPos(m_Pos.x + FONTSIZE_COMBO_X_LOCAL, m_Pos.y + FONTSIZE_COMBO_Y_LOCAL);
...
bool SEASON3B::CNewUIOptionWindow::UpdateMouseEvent()
{
    ...
    const ComboSlot slots[] = {
        ...
        { &m_FontSizeCombo,   &m_iFontSizeIndex,   &CNewUIOptionWindow::ApplyFontSize    },
...
void SEASON3B::CNewUIOptionWindow::RenderButtons()
{
    ...
    CNewUIComboBox* combos[] = { &m_ResolutionCombo, &m_LanguageCombo, &m_FontSizeCombo, &m_FontCombo };
